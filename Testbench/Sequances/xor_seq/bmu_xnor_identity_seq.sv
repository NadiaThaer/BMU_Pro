class bmu_xnor_identity_seq extends bmu_xor_base_sequence;
    `uvm_object_utils(bmu_xnor_identity_seq)
    
    function new(string name = "bmu_xnor_identity_seq");
        super.new(name);
    endfunction
    ...
    virtual task body();
        ...
        `uvm_info(get_type_name(), $sformatf("XNOR Identity: a_in=0x%08x, b_in=0x%08x, expected_result=0x%08x", 
